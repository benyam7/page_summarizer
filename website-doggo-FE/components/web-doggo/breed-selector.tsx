...
interface BreedInfo {
    id: 'openai' | 'ollama' | 'anthropic' | 'google' | 'groq' | 'deepseek';
    name: string;
    breed: string;
    description: string;
    color: string;
...
export const BreedSelector = ({
    ...
    const breeds: BreedInfo[] = [
        ...
        },
        {
            ...
            name: 'DeepSeek',
            breed: 'Husky',
            description: 'Powerful and efficient worker',
            color: 'bg-gradient-to-br from-indigo-400 to-blue-500',
            emoji: '🐺',
        },
    ];

    const selectedBreedInfo =
        breeds.find((b) => b.id === selectedBreed) || breeds[0];
    ...
    return (
        <div className="mb-4">
            ...
            <div className="relative">
                ...
                >
                    <motion.div
                        className={`flex items-center gap-3 p-3 rounded-2xl border-2 border-amber-300 dark:border-amber-600 bg-white/80 dark:bg-amber-900/20 ${
