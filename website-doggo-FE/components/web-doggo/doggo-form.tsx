...
export const DoggoForm = ({ onSubmit, initialValues, selectedProvider }: FormProps) => {
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <Label htmlFor="url" className="text-sm text-amber-800 dark:text-amber-200 font-medium">
              Website to Fetch
            </Label>
          </div>
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            <span className="text-lg">🦴</span>
            <Label htmlFor="apiKey" className="text-sm text-amber-800 dark:text-amber-200 font-medium">
              API Treat (Key)
            </Label>
          </div>
          <div className="relative">
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="advanced-settings" className="border-b-0">
            ...
            <AccordionContent className="space-y-4 pt-2 bg-amber-50/50 dark:bg-amber-900/20 rounded-xl p-3">
              ...
              {/* Base URL */}
              <div className="space-y-2">
                <Label htmlFor="baseUrl" className="text-sm text-amber-700 dark:text-amber-300 flex items-center gap-2">
                  <span>🏠</span>
